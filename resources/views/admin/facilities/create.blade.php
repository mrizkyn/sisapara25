                ...
                <form action="{{ route('admin.facilities.store') }}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control @error('name') is-invalid @enderror" id="name"
                            name="name" value="{{ old('name') }}" placeholder="Contoh: GOR Serbaguna" required>
                        @error('name')
                    ...
                    <div class="mb-3">
                        ...
                        <textarea class="form-control @error('description') is-invalid @enderror" id="description" name="description"
                            rows="4" placeholder="Tuliskan deskripsi singkat fasilitas..." required>{{ old('description') }}</textarea>
                        @error('description')
                            <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
                    </div>
                    ...
                    <div class="row">
                        <div class="col-md-4 mb-3">
                            ...
                            <input type="text" class="form-control @error('location') is-invalid @enderror"
                                ...
                                placeholder="Contoh: Jl. Melati No. 45, Bandung" required>
                            @error('location')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
                        <div class="col-md-4 mb-3">
                            ...
                            <input type="text" class="form-control @error('type') is-invalid @enderror" id="type"
                                ...
                                placeholder="Contoh: Lapangan Futsal, Kolam Renang" required>
                            @error('type')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
                        <div class="col-md-4 mb-3">
                            ...
                            <input type="number" class="form-control @error('capacity') is-invalid @enderror"
                                id="capacity" name="capacity" value="{{ old('capacity') }}" placeholder="Contoh: 100 orang"
                                required>
                            @error('capacity')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                    ...
                    <div class="row">
                        <div class="col-md-4 mb-3">
                            ...
                            <input type="text" class="form-control @error('account_name') is-invalid @enderror"
                                ...
                                placeholder="Contoh: Dinas Pemuda dan Olahraga" required>
                            @error('account_name')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
                        ...
                        <div class="col-md-4 mb-3">
                            ...
                            <input type="text" class="form-control @error('bank_name') is-invalid @enderror"
                                ...
                                placeholder="Contoh: BNI, BRI, Mandiri" required>
                            @error('bank_name')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
